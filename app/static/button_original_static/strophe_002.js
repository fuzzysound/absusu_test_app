(function (global, factory) {
  ...
  strophe_js.Strophe.addConnectionPlugin('muc', {
    ...
    oksusuMessage: function(room, nick, message, html_message, type, messageType, msgid) {
      var emoticonImg = '';
      ...
      msg.c("x", {
        xmlns: Chat.getServiceName()
      }).c("user").t(Chat.getUserJid());
      msg.up();
      msg.c("type").t(messageType);
      if (messageType === 'emoticon') {
        msg.up();
        msg.c("emoticon").t(emoticonImg);
      }
      this._connection.send(msg);
      return msgid;
    },
    ...
    oksusuGroupchat: function(room, message, messageType, html_message, msgid) {
      return this.oksusuMessage(room, null, message, html_message, void 0, messageType, msgid);
    },
  ...
  XmppRoom = (function() {
    ...
    XmppRoom.prototype.oksusuGroupchat = function(message, html_message, messageType) {
      return this.client.oksusuGroupchat(this.name, message, html_message, messageType);
    };
